...
public:
	...
	struct CHCVerificationTarget: VerificationTarget
	{
		...
		friend bool operator<(CHCVerificationTarget const& a, CHCVerificationTarget const& b)
		{
...
private:
	...
	std::pair<std::string, langutil::ErrorId> targetDescription(CHCVerificationTarget const& target);
