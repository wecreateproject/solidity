...
/// Throws an exception if condition is met with a given description and extra information about the location the
/// exception was thrown from.
/// @param _condition condition that need to met to throw the exception.
/// @param _exceptionType The type of the exception to throw (not an instance).
/// @param _description The message that describes the error.
#define solThrowIf(_condition, _exceptionType, _description) \
	if ((_condition))                                        \
